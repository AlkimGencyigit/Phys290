...
Original file is located at
    https://colab.research.google.com/drive/1MRfPj8VgKytOYPEOKOEHDW4qE_amsgVl
"""
...
def lightbot(str , initial_matris, initial_pos=[9,0], initial_dir=[0,1]):
  ...
  for i in range(len(str)):
    ...
    if str[i] == "*":
      ...
      #makes sure we dont go out of the matris
      if pos[0] < 9:
        if abs( int(matris[pos[0],pos[1]]) - int(matris[pos[0]+dir[0] , pos[1]+dir[1]])) <= 1:
          #makes sure there is only 1 height difference
          pos[0] += dir[0]
